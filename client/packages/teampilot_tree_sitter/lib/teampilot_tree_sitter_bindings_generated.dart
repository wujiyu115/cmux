...
external void ts_parser_delete(ffi.Pointer<TSParser> self);

/// Get the parser's current language.
@ffi.Native<ffi.Pointer<TSLanguage> Function(ffi.Pointer<TSParser>)>()
external ffi.Pointer<TSLanguage> ts_parser_language(ffi.Pointer<TSParser> self);
...
/// `count` pointer.
@ffi.Native<
  ffi.Pointer<TSRange> Function(ffi.Pointer<TSParser>, ffi.Pointer<ffi.Uint32>)
>()
...
>(symbol: 'ts_parser_parse_string_encoding')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>)>()
external void ts_parser_reset(ffi.Pointer<TSParser> self);
...
external int ts_parser_timeout_micros(ffi.Pointer<TSParser> self);
...
external void ts_parser_set_logger(ffi.Pointer<TSParser> self, TSLogger logger);

/// Get the parser's current logger.
@ffi.Native<TSLogger Function(ffi.Pointer<TSParser>)>()
external TSLogger ts_parser_logger(ffi.Pointer<TSParser> self);
...
external void ts_parser_print_dot_graphs(ffi.Pointer<TSParser> self, int fd);
...
external ffi.Pointer<TSTree> ts_tree_copy(ffi.Pointer<TSTree> self);

/// Delete the syntax tree, freeing all of the memory that it used.
@ffi.Native<ffi.Void Function(ffi.Pointer<TSTree>)>()
external void ts_tree_delete(ffi.Pointer<TSTree> self);

/// Get the root node of the syntax tree.
@ffi.Native<TSNode Function(ffi.Pointer<TSTree>)>()
external TSNode ts_tree_root_node(ffi.Pointer<TSTree> self);
...
external ffi.Pointer<TSLanguage> ts_tree_language(ffi.Pointer<TSTree> self);

/// Get the array of included ranges that was used to parse the syntax tree.
///
/// The returned pointer must be freed by the caller.
@ffi.Native<
  ffi.Pointer<TSRange> Function(ffi.Pointer<TSTree>, ffi.Pointer<ffi.Uint32>)
>()
...
external ffi.Pointer<ffi.Char> ts_node_type(TSNode self);

/// Get the node's type as a numerical id.
@ffi.Native<TSSymbol Function(TSNode)>()
external int ts_node_symbol(TSNode self);

/// Get the node's language.
@ffi.Native<ffi.Pointer<TSLanguage> Function(TSNode)>()
external ffi.Pointer<TSLanguage> ts_node_language(TSNode self);

/// Get the node's type as it appears in the grammar ignoring aliases as a
/// null-terminated string.
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode)>()
external ffi.Pointer<ffi.Char> ts_node_grammar_type(TSNode self);

/// Get the node's type as a numerical id as it appears in the grammar ignoring
/// aliases. This should be used in [`ts_language_next_state`] instead of
/// [`ts_node_symbol`].
@ffi.Native<TSSymbol Function(TSNode)>()
external int ts_node_grammar_symbol(TSNode self);

/// Get the node's start byte.
@ffi.Native<ffi.Uint32 Function(TSNode)>()
external int ts_node_start_byte(TSNode self);

/// Get the node's start position in terms of rows and columns.
@ffi.Native<TSPoint Function(TSNode)>()
external TSPoint ts_node_start_point(TSNode self);

/// Get the node's end byte.
@ffi.Native<ffi.Uint32 Function(TSNode)>()
external int ts_node_end_byte(TSNode self);

/// Get the node's end position in terms of rows and columns.
@ffi.Native<TSPoint Function(TSNode)>()
external TSPoint ts_node_end_point(TSNode self);
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode)>()
external ffi.Pointer<ffi.Char> ts_node_string(TSNode self);

/// Check if the node is null. Functions like [`ts_node_child`] and
/// [`ts_node_next_sibling`] will return a null node to indicate that no such node
/// was found.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_is_null(TSNode self);

/// Check if the node is *named*. Named nodes correspond to named rules in the
/// grammar, whereas *anonymous* nodes correspond to string literals in the
/// grammar.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_is_named(TSNode self);

/// Check if the node is *missing*. Missing nodes are inserted by the parser in
/// order to recover from certain kinds of syntax errors.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_is_missing(TSNode self);

/// Check if the node is *extra*. Extra nodes represent things like comments,
/// which are not required the grammar, but can appear anywhere.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_is_extra(TSNode self);

/// Check if a syntax node has been edited.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_has_changes(TSNode self);

/// Check if the node is a syntax error or contains any syntax errors.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_has_error(TSNode self);

/// Check if the node is a syntax error.
@ffi.Native<ffi.Bool Function(TSNode)>()
external bool ts_node_is_error(TSNode self);

/// Get this node's parse state.
@ffi.Native<TSStateId Function(TSNode)>()
external int ts_node_parse_state(TSNode self);

/// Get the parse state after this node.
@ffi.Native<TSStateId Function(TSNode)>()
external int ts_node_next_parse_state(TSNode self);

/// Get the node's immediate parent.
/// Prefer [`ts_node_child_with_descendant`] for
/// iterating over the node's ancestors.
@ffi.Native<TSNode Function(TSNode)>()
external TSNode ts_node_parent(TSNode self);

/// Get the node that contains `descendant`.
///
/// Note that this can return `descendant` itself.
@ffi.Native<TSNode Function(TSNode, TSNode)>()
external TSNode ts_node_child_with_descendant(TSNode self, TSNode descendant);

/// Get the node's child at the given index, where zero represents the first
/// child.
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>()
external TSNode ts_node_child(TSNode self, int child_index);
...
@ffi.Native<ffi.Uint32 Function(TSNode)>()
external int ts_node_child_count(TSNode self);

/// Get the node's *named* child at the given index.
///
/// See also [`ts_node_is_named`].
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>()
external TSNode ts_node_named_child(TSNode self, int child_index);

/// Get the node's number of *named* children.
///
/// See also [`ts_node_is_named`].
@ffi.Native<ffi.Uint32 Function(TSNode)>()
external int ts_node_named_child_count(TSNode self);
...
external TSNode ts_node_child_by_field_id(TSNode self, int field_id);

/// Get the node's next / previous sibling.
@ffi.Native<TSNode Function(TSNode)>()
external TSNode ts_node_next_sibling(TSNode self);

@ffi.Native<TSNode Function(TSNode)>()
external TSNode ts_node_prev_sibling(TSNode self);

/// Get the node's next / previous *named* sibling.
@ffi.Native<TSNode Function(TSNode)>()
external TSNode ts_node_next_named_sibling(TSNode self);

@ffi.Native<TSNode Function(TSNode)>()
external TSNode ts_node_prev_named_sibling(TSNode self);

/// Get the node's first child that contains or starts after the given byte offset.
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>()
external TSNode ts_node_first_child_for_byte(TSNode self, int byte);

/// Get the node's first named child that contains or starts after the given byte offset.
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>()
external TSNode ts_node_first_named_child_for_byte(TSNode self, int byte);

/// Get the node's number of descendants, including one for the node itself.
@ffi.Native<ffi.Uint32 Function(TSNode)>()
external int ts_node_descendant_count(TSNode self);
...
external bool ts_node_eq(TSNode self, TSNode other);
...
external TSTreeCursor ts_tree_cursor_new(TSNode node);

/// Delete a tree cursor, freeing all of the memory that it used.
@ffi.Native<ffi.Void Function(ffi.Pointer<TSTreeCursor>)>()
external void ts_tree_cursor_delete(ffi.Pointer<TSTreeCursor> self);
...
external void ts_tree_cursor_reset(ffi.Pointer<TSTreeCursor> self, TSNode node);
...
external TSNode ts_tree_cursor_current_node(ffi.Pointer<TSTreeCursor> self);
...
external int ts_tree_cursor_current_field_id(ffi.Pointer<TSTreeCursor> self);
...
external bool ts_tree_cursor_goto_parent(ffi.Pointer<TSTreeCursor> self);
...
/// of the cursor, and the cursor cannot walk outside this node.
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>()
external bool ts_tree_cursor_goto_next_sibling(ffi.Pointer<TSTreeCursor> self);
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>()
external bool ts_tree_cursor_goto_first_child(ffi.Pointer<TSTreeCursor> self);
...
/// position.
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>()
external bool ts_tree_cursor_goto_last_child(ffi.Pointer<TSTreeCursor> self);
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSTreeCursor>)>()
external int ts_tree_cursor_current_depth(ffi.Pointer<TSTreeCursor> self);
...
external TSTreeCursor ts_tree_cursor_copy(ffi.Pointer<TSTreeCursor> cursor);
...
external void ts_query_delete(ffi.Pointer<TSQuery> self);

/// Get the number of patterns, captures, or string literals in the query.
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>()
external int ts_query_pattern_count(ffi.Pointer<TSQuery> self);

@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>()
external int ts_query_capture_count(ffi.Pointer<TSQuery> self);

@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>()
external int ts_query_string_count(ffi.Pointer<TSQuery> self);
...
external void ts_query_cursor_delete(ffi.Pointer<TSQueryCursor> self);
...
external int ts_query_cursor_match_limit(ffi.Pointer<TSQueryCursor> self);
...
external int ts_query_cursor_timeout_micros(ffi.Pointer<TSQueryCursor> self);
...
external ffi.Pointer<TSLanguage> ts_language_copy(ffi.Pointer<TSLanguage> self);

/// Free any dynamically-allocated resources for this language, if
/// this is the last reference.
@ffi.Native<ffi.Void Function(ffi.Pointer<TSLanguage>)>()
external void ts_language_delete(ffi.Pointer<TSLanguage> self);

/// Get the number of distinct node types in the language.
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>()
external int ts_language_symbol_count(ffi.Pointer<TSLanguage> self);

/// Get the number of valid states in this language.
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>()
external int ts_language_state_count(ffi.Pointer<TSLanguage> self);
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>()
external int ts_language_field_count(ffi.Pointer<TSLanguage> self);
...
@ffi.Native<
  TSFieldId Function(ffi.Pointer<TSLanguage>, ffi.Pointer<ffi.Char>, ffi.Uint32)
>()
...
external int _ts_language_symbol_type(ffi.Pointer<TSLanguage> self, int symbol);

TSSymbolType ts_language_symbol_type(
  ffi.Pointer<TSLanguage> self,
  DartTSSymbol symbol,
) => TSSymbolType.fromValue(_ts_language_symbol_type(self, symbol));
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>()
external int ts_language_version(ffi.Pointer<TSLanguage> self);
...
/// See also [`ts_parser_set_language`].
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>()
external int ts_language_abi_version(ffi.Pointer<TSLanguage> self);
...
external ffi.Pointer<ffi.Char> ts_language_name(ffi.Pointer<TSLanguage> self);
...
@ffi.Native<
  ffi.Pointer<TSLookaheadIterator> Function(ffi.Pointer<TSLanguage>, TSStateId)
>()
...
external bool ts_lookahead_iterator_next(ffi.Pointer<TSLookaheadIterator> self);
...
external void ts_wasm_store_delete(ffi.Pointer<TSWasmStore> arg0);
...
external int ts_wasm_store_language_count(ffi.Pointer<TSWasmStore> arg0);
...
external bool ts_language_is_wasm(ffi.Pointer<TSLanguage> arg0);
...
enum TSQuantifier {
  /// must match the array initialization value
  TSQuantifierZero(0),
