...
# grammar.js + scanner.c. Make ships one, but generated by an old CLI (ABI 13)
# whose parse-action macros MSVC rejects. Generate parser.c with the pinned
# tree-sitter CLI (tree-sitter-cli 0.25.6 matches core v0.25.10's ABI range)
# before copying.
GENERATED_GRAMMARS=(
  ...
  "make|https://github.com/alemuller/tree-sitter-make.git|a4b9187417d6be349ee5fd4b6e77b4172c6827dd"
)
